...
local function load()
 ...
 -- lcd.setColor(TEXT_BGCOLOR, LIGHTGREY)
 -- lcd.setColor(TEXT_INVERTED_COLOR, LIGHTGREY)
--  lcd.setColor(TEXT_INVERTED_BGCOLOR, LIGHTGREY)
...
--  lcd.setColor(MENU_TITLE_DISABLE_COLOR, LIGHTGREY)
...
--  lcd.setColor(HEADER_BGCOLOR, LIGHTGREY)
 -- lcd.setColor(HEADER_ICON_BGCOLOR, LIGHTGREY)
--  lcd.setColor(HEADER_CURRENT_BGCOLOR, lcd.RGB(10, 78, 121))
--  lcd.setColor(OVERLAY_COLOR, LIGHTGREY)
...
return { name="Attitude", load=load, drawBackground=drawBackground, drawTopbarBackground=drawTopbarBackground }
